(ns marketentry.store
  "SSoT for the Malawi (MWI) market-entry compliance actor, behind a
...
(defn demo-data
  ...
  `:seeking-msme-set-aside?` / `:msme-declared-category` /
  `:annual-turnover-mwk` / `:employee-count` / `:assets-mwk` are ground
  truth for the `msme-set-aside-ineligible` flagship check (Public
  Procurement and Disposal of Public Assets Act, No. 7 of 2025,
  s.62(11) + the Participation by Micro, Small and Medium Enterprises
  Order, 2020); `:requires-tpin-record?` / `:tpin-record-verified?` are
  ground truth for the conditional MRA TPIN-record check."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Lilongwe Fabrication Ltd" :portal "ppda.mw/suppliers"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :seeking-msme-set-aside? false :msme-declared-category nil
             :annual-turnover-mwk 0.0 :employee-count 0 :assets-mwk 0.0
             :requires-tpin-record? true :tpin-record-verified? true
             :drafted? false :submitted? false
             :jurisdiction "MWI" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "ppda.mw/suppliers"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :seeking-msme-set-aside? false :msme-declared-category nil
             :annual-turnover-mwk 0.0 :employee-count 0 :assets-mwk 0.0
    ...
    "eng-3" {:id "eng-3" :operator "Blantyre Systems Ltd" :portal "ppda.mw/suppliers"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "MWI" :status :intake}
    "eng-4" {:id "eng-4" :operator "Mzuzu Agro Investments" :portal "ppda.mw/suppliers"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ;; declares :small, but turnover AND assets are both actually
             ;; medium-tier (only employee-count is small-tier) -- 1 of 3
             ;; criteria met, ineligible for the :small set-aside it claims
             :seeking-msme-set-aside? true :msme-declared-category :small
             :annual-turnover-mwk 60000000.0 :employee-count 8 :assets-mwk 30000000.0
             :requires-tpin-record? true :tpin-record-verified? true
             :drafted? false :submitted? false
             :jurisdiction "MWI" :status :intake}
    "eng-5" {:id "eng-5" :operator "Zomba Logistics Ltd" :portal "ppda.mw/suppliers"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :seeking-msme-set-aside? false :msme-declared-category nil
             :annual-turnover-mwk 0.0 :employee-count 0 :assets-mwk 0.0
             :requires-tpin-record? true :tpin-record-verified? false
             :drafted? false :submitted? false
             :jurisdiction "MWI" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               seeking-msme-set-aside? msme-declared-category
                               annual-turnover-mwk employee-count assets-mwk
                               requires-tpin-record? tpin-record-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? seeking-msme-set-aside?)       (assoc :engagement/seeking-msme-set-aside? seeking-msme-set-aside?)
    msme-declared-category                (assoc :engagement/msme-declared-category msme-declared-category)
    (some? annual-turnover-mwk)           (assoc :engagement/annual-turnover-mwk annual-turnover-mwk)
    (some? employee-count)                (assoc :engagement/employee-count employee-count)
    (some? assets-mwk)                    (assoc :engagement/assets-mwk assets-mwk)
    (some? requires-tpin-record?)         (assoc :engagement/requires-tpin-record? requires-tpin-record?)
    (some? tpin-record-verified?)         (assoc :engagement/tpin-record-verified? tpin-record-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/seeking-msme-set-aside? :engagement/msme-declared-category
   :engagement/annual-turnover-mwk :engagement/employee-count :engagement/assets-mwk
   :engagement/requires-tpin-record? :engagement/tpin-record-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :seeking-msme-set-aside? (boolean (:engagement/seeking-msme-set-aside? m))
     :msme-declared-category (:engagement/msme-declared-category m)
     :annual-turnover-mwk (:engagement/annual-turnover-mwk m)
     :employee-count (:engagement/employee-count m)
     :assets-mwk (:engagement/assets-mwk m)
     :requires-tpin-record? (boolean (:engagement/requires-tpin-record? m))
     :tpin-record-verified? (boolean (:engagement/tpin-record-verified? m))
